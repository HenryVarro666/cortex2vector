...
if __name__ == '__main__':
    input_root = './Graph_embedding_data_Test1/adj_feature_matrix_Test1'
    out_root = './Graph_embedding_data_Test1'
    multi_hop_feature_outdir = out_root + '/' + 'multi_hop_feature_matrix_Test1'
    node_outdir = out_root + '/' + 'node_input_data_Test1'
